...
//		}
		...
		response.setHeader("Access-Control-Allow-Headers", "tokenId, Content-Type, Accept, X-Requested-With, Access-Control-Request-Method, Access-Control-Request-Headers, remember-me");
