...
public class Replacements {
	...
	private final static String EDITORIAL_NEWS = "Der US-amerikanische Präsident Donald Trump und sein chinesischer Amtskollege Xi Jinping sind sich bei der Einigung des Handelskonflikts in den vergangenen Tagen näher gekommen, was zu steigenden Aktienmärkten geführt hat. Tarife und Zölle schmälern die Unternehmensgewinne, weil die Kauflaune der Bevölkerung auf Grund von höheren Preisen sinkt. Höhere Preise = weniger Nachfrage = weniger Umsatz der Unternehmen. Außerdem haben in den letzten Wochen viele Unternehmen eine gute Gewinnentwicklung gezeigt.";
	private final static String EDITORIAL_PORTFOLIO_INFO_100 = "Du bist unter anderem mit 1,5% deines Portfolios an Apple beteiligt. Mit seinen Smartphones verdient der Konzern weiterhin viel Geld, was die Aktie von Apple um 7% gesteigert hat. Apple ist vor Microsoft übrigens Dein größtes Einzelinvestment.";
	private final static String EDITORIAL_PORTFOLIO_STATISTICS_100 = "Du bist mit Deinem Portfolio in über 3.000 Einzelwerte investiert, wobei rund 60% davon in den USA sind.";
	...
	private final static String EDITORIAL_LOAN_100 = "Eine Anleihe berechtigt - im Gegensatz zu einer Aktie - zum Erhalt eines jährlichen Kupons. Das kannst Du dir als eine Art Verzinsung vorstellen. Im Gegensatz zu einer Aktie bist Du damit aber nicht Teileigentümer des Unternehmens. Aktuell bist Du zu 15% in Anleihen investiert.";
	...
	public Replacements () {
		replacementMap.put("editorial.news", EDITORIAL_NEWS);
		replacementMap.put("editorial.portfolio.info", EDITORIAL_PORTFOLIO_INFO_100);
		replacementMap.put("editorial.portfolio.statistics", EDITORIAL_PORTFOLIO_STATISTICS_100);
		replacementMap.put("{editorial.info.investmal.basics(0)", EDITORIAL_INFO_INVESTMAL_BASICS_0);
		replacementMap.put("editorial.loan(100)", EDITORIAL_LOAN_100);
